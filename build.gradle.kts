...
subprojects {
    ...
    dependencies {
        ...
        implementation(Deps.SNAKE_YAML)
        ...
        tasks.withType<Jar> {
            ...
            manifest {
                attributes(
                    ...
                    "Implementation-Version" to ProjectInfo.version,
                    "Build-Time-ISO-8601" to ZonedDateTime.now().format(DateTimeFormatter.ISO_OFFSET_DATE_TIME),
                    "Built-By" to "Priyak Dey",
                    "Build-Jdk" to JavaVersion.VERSION_24.toString(),
                    "Implementation-URL" to "https://github.com/priyakdey/${rootProject.name}/tree/main/${project.name}",
                )
            }
        }
    }
